# Комментарии к разработанному приложению #
...
Персистентность данных обеспечивается использованием реляционной базы данных PostgreSQL. Для тестов используется временная база H2.
Код продокументирован в соответствии с Javadoc.   
Приложение запущено в контейнере Docker и доступно по адресу: [https://louis-2087.usr.yandex-academy.ru](https://louis-2087.usr.yandex-academy.ru)
